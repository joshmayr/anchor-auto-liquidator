...
exports.fabricatebEthDecreaseAllowance = void 0;
...
const fabricatebEthDecreaseAllowance = ({ address, amount, spender, expires }) => (addressProvider) => {
    (0, validate_input_1.validateInput)([
        ...
        (0, address_1.validateAddress)(spender),
    ]);
    const bEthTokenAddress = addressProvider.bEthToken();
    return [
        new terra_js_1.MsgExecuteContract(address, bEthTokenAddress, {
            decrease_allowance: {
                spender: spender,
...
exports.fabricatebEthDecreaseAllowance = fabricatebEthDecreaseAllowance;
//# sourceMappingURL=beth-decrease-allowance.js.map