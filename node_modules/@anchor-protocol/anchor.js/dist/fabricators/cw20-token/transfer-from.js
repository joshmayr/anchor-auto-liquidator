...
exports.fabricateCw20TransferFrom = void 0;
...
const fabricateCw20TransferFrom = ({ address, amount, contract_address, owner, recipient, }) => {
    (0, validate_input_1.validateInput)([
        ...
        (0, address_1.validateAddress)(recipient),
    ]);
    return [
...
exports.fabricateCw20TransferFrom = fabricateCw20TransferFrom;
