...
exports.fabricateExchangeWithdrawLiquiditybLuna = void 0;
...
const fabricateExchangeWithdrawLiquiditybLuna = ({ address, amount }) => (addressProvider) => {
    ...
    return [
        new terra_js_1.MsgExecuteContract(address, lpToken, {
            send: {
...
exports.fabricateExchangeWithdrawLiquiditybLuna = fabricateExchangeWithdrawLiquiditybLuna;
//# sourceMappingURL=withdraw-liquidity-bluna.js.map