...
const queryOraclePrices = ({ lcd, start_after, limit }) => (addressProvider) => __awaiter(void 0, void 0, void 0, function* () {
    const oracleContractAddress = addressProvider.oracle();
    return yield lcd.wasm
        .contractQuery(oracleContractAddress, {
        prices: {
